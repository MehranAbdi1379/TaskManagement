...
const TaskComments: React.FC<TaskCommentsProps> = ({taskId}) => {
    ...
    const [taskCommentTotalPages, setTaskCommentTotalPages] = useState(1);
    ...
    const fetchTaskComments = async () => {
        ...
        setTaskCommentTotalPages(totalPages);
    };
    useEffect(() => {
        fetchTaskComments();
    }, [
    ...
    return (
        ...
        >
            ...
            {taskCommentTotalPages != 0 && taskCommentTotalPages > 0 && (
                <>
                    <Flex justify="center" mt={8} gap={4} align="center">
                        ...
                        <Text>
                            Page {pageNumber} of {taskCommentTotalPages}
                        </Text>
                        <Button
                            onClick={() =>
                                setPageNumber((prev) => Math.min(prev + 1, taskCommentTotalPages))
                            }
                            disabled={pageNumber === taskCommentTotalPages}
                        >
                            Next
                        </Button>
                    </Flex>
